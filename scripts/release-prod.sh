...
REQUIRED_PRODUCTION_ENVS_CSV="${REQUIRED_PRODUCTION_ENVS_CSV:-DATABASE_URL,CANONICAL_HOST,NEXT_PUBLIC_CANONICAL_HOST,NEXT_PUBLIC_GA_MEASUREMENT_ID,FORMSPREE_APPOINTMENT_ENDPOINT,FORMSPREE_CONTACT_ENDPOINT}"
